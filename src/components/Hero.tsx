  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-4 sm:px-6 text-center">
        ...
        {/* MOTTO — wraps naturally on all screen sizes */}
        <div className="text-base sm:text-lg md:text-xl max-w-3xl mx-auto mb-8 sm:mb-10 leading-relaxed px-2 sm:px-0">
          {isInView && (
            <div className="flex flex-col items-center">
              {/* Motto text — wrapped in a block so it can break lines naturally */}
        ...
        {/* BUTTONS — always auto-width, never full-width */}
        <div 
        ...
        >
          <button 
            ...
            className="px-6 sm:px-8 py-3 sm:py-3.5 border border-gray-300 bg-white/90 backdrop-blur-sm text-gray-900 rounded-full font-medium hover:border-gray-900 hover:bg-gray-50 hover:scale-105 active:scale-95 transition-all duration-200 text-sm sm:text-base shadow-sm hover:shadow-md"
          >
            View portfolio
          </button>
          <button 
            onClick={handleHireUs}
            className="px-6 sm:px-8 py-3 sm:py-3.5 bg-red-600 text-white rounded-full font-medium hover:bg-red-700 hover:scale-105 active:scale-95 transition-all duration-200 text-sm sm:text-base shadow-lg shadow-red-600/25 hover:shadow-xl hover:shadow-red-600/30"
          >
            Hire us
          </button>
        </div>
